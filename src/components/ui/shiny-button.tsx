...
export function ShinyButton({ children, onClick, className = "", href }: ShinyButtonProps) {
  const styles = `
    ...
    .shiny-cta {
      ...
      --shiny-cta-highlight-subtle: #DDD6FE;
    ...
    .shiny-cta span { z-index: 1; display: flex; align-items: center; gap: 0.5rem; }
    .shiny-cta span::before {
      ...
      animation: calc(var(--duration) * 1.5) breathe-btn linear infinite;
    }
    ...
    @keyframes shimmer-btn { to { rotate: 360deg; } }
